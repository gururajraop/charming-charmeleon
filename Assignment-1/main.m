...
threshold = 0.0000001;
icp_3_1(3,sample_type, sample_size, threshold, n_iterations, matching_type);
% icp_3_1_reverseorder(3,sample_type, sample_size, threshold, n_iterations, matching_type);
% icp_3_2(3,sample_type, sample_size, threshold, n_iterations, matching_type);
